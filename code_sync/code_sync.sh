...
# 环境变量配置
#===========================================
export REPO_URL="${REPO_URL:-ssh://wangxu46@icode.baidu.com:8235/baidu/xpu/XMLIR}"  # 需要更改到QA的链接
export REPO_DIR="${REPO_DIR:-./XMLIR}"
# master 和 v2.9.0 使用不同的同步基准点
export MASTER_SYNC_BASE="${MASTER_SYNC_BASE:-bfdf823}"
export TARGET_SYNC_BASE="${TARGET_SYNC_BASE:-4be9942}"
